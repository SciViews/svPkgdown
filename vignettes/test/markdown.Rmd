...
The {svSweave} package eases writing and referencing numbered display equations from any R Markdown documents, see[svSweave documentation](https://www.sciviews.org/svSweave/).
